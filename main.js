...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-5ZELM2LV.js").then((m) => m.LoginPage)
  },
  {
    path: "cars",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-SV7LXFQQ.js").then((m) => m.CarsPage)
  },
  {
    path: "cars/:id/reserve",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-G54MQEWH.js").then((m) => m.ReservationPage)
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-YLNQSWVN.js").then((m) => m.HistoryPage)
  },
