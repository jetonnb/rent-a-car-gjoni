...
var h2 = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./chunk-VGCU5B24.js")).iosTransitionAnimation : (await import("./chunk-5KMOTVCF.js")).mdTransitionAnimation;
};
var y = async (n3, e) => {
  await k(e, true);
...
@ionic/core/components/p-9VcRUwdB.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6C5M3URP.js.map
