...
var DataService = class _DataService {
  ...
  getCarsRaw$() {
    return this.fromSnapshot(collection(this.firestore, this.CARS_PATH)).pipe(shareReplay({ bufferSize: 1, refCount: true }));
  }
  getResRaw$() {
    return this.fromSnapshot(collection(this.firestore, this.RES_PATH)).pipe(map((docs) => docs.map((d) => this.mapReservation(d))), shareReplay({ bufferSize: 1, refCount: true }));
  }
  mapReservation(data) {
...
//# sourceMappingURL=chunk-MYUUSVON.js.map
